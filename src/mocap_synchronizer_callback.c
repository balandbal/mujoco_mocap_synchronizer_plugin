...
void mocap_synchronizer_callback(const mjModel* model, mjData* data)
{
    int body_id = mj_name2id(model, mjOBJ_BODY, "mocap_synchronizer:body");
    int mocap_id = model->body_mocapid[mj_name2id(model, mjOBJ_BODY, "mocap_synchronizer:mocap")];
